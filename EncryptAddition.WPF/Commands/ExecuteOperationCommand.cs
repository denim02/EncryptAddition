    ...
    public class ExecuteOperationCommand : BaseAsyncCommand
    {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            try
            {
                ...
                encryptServiceStore = _encryptTabViewModel.IsKeyAutoGenerated ? EncryptServiceStore.GetInstance(_encryptTabViewModel.EncryptionChoice, _encryptTabViewModel.BitLength) : EncryptServiceStore.GetInstance(_encryptTabViewModel.EncryptionChoice, _encryptTabViewModel.SerializedCustomKey);
                ...
                var results = await (_encryptTabViewModel.OperationChoice == DataTypes.OperationChoice.ENCRYPTION ?
                    _encryptionAdapter.Encrypt(_encryptTabViewModel.EncryptionInputValues) :
                    _encryptionAdapter.Decrypt(_encryptTabViewModel.DecryptionInputValues));
